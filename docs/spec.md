...
- OSR - 8 bit register
  ...
  - Source mode register (`0x0` - memory, `0x1` - pointer, `0x2` - immediate)
  - Destination mode register (`0x0` - memory, `0x1` - pointer)
...
### CPU move additions (V1.4)

- `0000 0000` `0001 1001` - `SDM` - Set destination mode (auto-generated by the assembler)
- `0000 0000` `0001 1010` - `SSM` - Set source mode (auto-generated by the assembler)
- `0000 0000` `0001 1011` - `MOV` - Move value from source to destination
